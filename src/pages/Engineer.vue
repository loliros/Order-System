<template>
  <div class="demo-input-suffix">
    <div><!--https://jsonplaceholder.typicode.com/posts/    action把图片上传到服务器 现在无法使用-->
    ...
    <div class="boxborder">
      <el-button @click="dataInput(Menuinput2,Menuinput3)" type="primary" round style="margin-left: 20px">提交按钮</el-button>
      <el-button @click="dataempty" type="primary" round style="margin-left: 20px">清空按钮</el-button>
    </div>
  </div>
</template>
